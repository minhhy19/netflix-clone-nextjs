...
function Login() {
  ...
  return (
    <div className='relative flex h-screen w-screen flex-col bg-black md:items-center md:justify-center md:bg-transparent'>
      ...
      <Image
        src="https://assets.nflxext.com/ffe/siteui/vlv3/935156fb-9579-4fc2-ad94-70680402b8ef/c7a33a7d-7449-4f82-aea0-ab143230ac13/VN-vi-20230109-popsignuptwoweeks-perspective_alpha_website_large.jpg"
